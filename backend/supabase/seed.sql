...
-- Students (trigger auto-creates auth users)
...
('2025-08-05', 'Program Kickoff',               4, 2.0, 'offline'),
('2025-08-08', '8-Layer AI Stack',              4, 2.0, 'offline'),
('2025-08-12', 'Python Crash Course',           4, 2.0, 'offline'),
('2025-08-15', 'Data Structures for AI',        4, 2.0, 'offline'),
('2025-08-19', 'Intro to Machine Learning',     4, 2.0, 'offline'),
('2025-09-02', 'Neural Networks Basics',        5, 2.0, 'offline'),
('2025-09-05', 'Backpropagation',               5, 2.0, 'offline'),
('2025-09-09', 'CNNs & Computer Vision',        5, 2.0, 'offline'),
('2025-09-12', 'RNNs & NLP',                   5, 2.0, 'offline'),
('2025-09-16', 'Transformers Overview',         5, 2.0, 'offline'),
('2025-10-07', 'Large Language Models',         6, 2.0, 'offline'),
('2025-10-10', 'ReAct Agent Pattern',           6, 2.0, 'offline'),
('2025-10-14', 'pgvector RAG',                  6, 2.0, 'offline'),
('2025-10-17', 'LangChain Basics',              6, 2.0, 'offline'),
('2025-10-21', 'Tiered Autonomy Multi-Agent',   6, 2.0, 'offline')
ON CONFLICT (date) DO NOTHING;

-- Attendance (80% presence rate for all students x sessions)
DO $$
DECLARE
    student record;
    sess record;
...
(2,  '8-Layer AI Stack Slides',     'slides',    'https://docs.google.com/presentation/', 'Full slide deck covering the 8-Layer AI Stack framework'),
(2,  '8-Layer AI Stack Recording',  'recording', 'https://youtube.com/',                  'Session recording on YouTube'),
(12, 'ReAct Pattern PDF',           'document',  'https://drive.google.com/',             'Research paper and notes on the ReAct pattern'),
(12, 'ReAct Code Repo',             'link',      'https://github.com/',                   'GitHub repository with implementation examples'),
(13, 'pgvector RAG Slides',         'slides',    'https://docs.google.com/presentation/', 'Slides for the pgvector RAG session'),
(13, 'pgvector Demo Notebook',      'link',      'https://colab.research.google.com/',    'Google Colab notebook with live demo')
ON CONFLICT (id) DO NOTHING;

-- Import Log
INSERT INTO public.import_log (filename, uploaded_by, total_rows, imported_rows, skipped_rows, status) VALUES
('month4_attendance.csv', 'Nischay B K', 125, 120, 5, 'completed'),
('month5_attendance.csv', 'Nischay B K', 125, 125, 0, 'completed')
ON CONFLICT (id) DO NOTHING;
